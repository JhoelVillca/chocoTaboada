            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block">
                        <a href="{{ url('/') }}" class="btn btn-success text-white font-weight-bold">
                            <i class="bi bi-shop"></i> Ver Tienda Pública
                        </a>
                    </li>
                </ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('AdminLTE/assets/img/user8-128x128.jpg') }}"
                                            alt="User Avatar" class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('AdminLTE/assets/img/user3-128x128.jpg') }}"
                                            alt="User Avatar" class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                ...
                <li class="nav-item">
                    <a href="{{ route('pedido.index') }}" class="nav-link {{ request()->routeIs('pedido.*') ? 'active' : '' }}">
                        <i class="nav-icon fas fa-shopping-cart"></i>
                        <p>Pedidos / Ventas</p>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('categoria.*') || request()->routeIs('producto.*') || request()->routeIs('lote.*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ request()->routeIs('categoria.*') || request()->routeIs('producto.*') || request()->routeIs('lote.*') ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('producto.index') }}" class="nav-link {{ request()->routeIs('producto.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Productos</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('lote.index') }}" class="nav-link {{ request()->routeIs('lote.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Lotes (Vencimiento)</p>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a href="{{ url('/') }}" class="nav-link text-white bg-success" target="_blank">
